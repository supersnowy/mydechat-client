export const server = 'https://mydechat.herokuapp.com';

//emoji routes
const openEmojiApiKey = `bbc0c9d1399ee9987cf6e881388a0dbb428a693d`;
...
//giphy toutes
const giphyApiKey = `Zjt1Bkv8oCVzW29pKGDpcO6MRLS7DnBw`;
