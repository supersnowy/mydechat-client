...
const ProfileCard = (props) => {
    ...
    return (
        <CardContainer variants={variants} key={props._id}>
            <img src={props.dp} alt={props.userName !== "" ? props.userName : shorten(props.walletAddr)} loading='lazy' />
            <p className='status' title={props.status}>{props.status}</p>
            <p className='userName'>{props.userName !== "" ? props.userName : shorten(props.walletAddr)}</p>
            {
            ...
            <div className="actions">
                            ...
                            if (isPresent) {
                                if (isPresent.type === 'sent')
                                    ...
                                    return (
                                        <StyledButton
                                            ...
                                            toolTip={`cancel requset sent to ${props.userName !== "" ? props.userName : shorten(props.walletAddr)}`}
                                            color='secondary'
                                            frontIcon={HiUserRemove}
                                            iconSize='15px'
                                    ...
                                    return (
                                        <>
                                            <StyledButton
                                                title='confirm'
                                                toolTip={`confirm adding  ${props.userName !== "" ? props.userName : shorten(props.walletAddr)} to contacts`}
                                                frontIcon={HiUserAdd}
                                                iconSize='15px'
                                            ...
                                            <StyledButton
                                                title='reject'
                                                toolTip={`decline adding ${props.userName !== "" ? props.userName : shorten(props.walletAddr)} to contacts`}
                                                color='secondary'
                                                frontIcon={HiUserRemove}
                                                iconSize='15px'
                                ...
                                return (
                                    <StyledButton
                                        ...
                                        toolTip={`request ${props.userName !== "" ? props.userName : shorten(props.walletAddr)} to add you to his contacts`}
                                        frontIcon={HiUserAdd}
                                        iconSize='15px'
                                        onClick={addHandler}
                                    />
                ...
                <StyledButton
                    ...
                    toolTip={`start a chat with ${props.userName !== "" ? props.userName : shorten(props.walletAddr)}`}
                />
            </div>
        </CardContainer>
    );
